...
class providerSchema(Schema):
    ...
    provider_vms_capacity = fields.String()
    provider_networks_capacity = fields.String()
    ...
    provider_created_at = fields.DateTime(required=True)
    provider_updated_at = fields.DateTime()
